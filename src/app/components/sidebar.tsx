                    ...
                    <ul className="space-y-2 font-medium">
                        <li>
                            ...
                            <ul id="dropdown-example" className="hidden py-2 space-y-2">
                                ...
                                <li>
                                    <a href="#" className="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Personas</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            <Link href="/equipos" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
