                ...
                <ul>
                  <li>
                    <Link href="/empresas" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                      <svg className='text-gray-700 h-6 w-6 stroke-5' xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 28 35">
                  ...
                  <li>
                    <Link href="/areas" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                      <svg className='text-gray-700 h-6 w-6 stroke-5' xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28">
                      ...
                      <span className="flex-1 ms-2 whitespace-nowrap">Areas</span>
                    </Link>
                  </li>
                  <li>
                    <Link href="/certificadoras" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                      <svg className='text-gray-700 h-6 w-6 stroke-5' xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="-1 -1 17 17">
                      ...
                      <span className="flex-1 ms-2 whitespace-nowrap">Certificadoras</span>
                    </Link>
                  </li>
                  <li>
                    <Link href="/usuarios" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                      <svg className='text-gray-700 h-6 w-6 stroke-5' xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            ...
            <div className='pb-3'>
              <li className='mt-auto'>
                <Link href="/logout" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                  <svg className='text-gray-700 h-6 w-6 stroke-5' xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M5 21q-.825 0-1.412-.587T3 19V5q0-.825.588-1.412T5 3h7v2H5v14h7v2zm11-4l-1.375-1.45l2.55-2.55H9v-2h8.175l-2.55-2.55L16 7l5 5z"/></svg>
                      
                  <span className="flex-1 ms-2 whitespace-nowrap">Salir</span>
                </Link>
              </li>
            </div>
          </ul>
