...
const CrearEquipoPage: React.FC = () => {
    ...
    const { setValue, getValues, register, handleSubmit, formState: { errors } } = useForm<FormData>();
            ...
            <div className="w-full max-w-4xl bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    {/* <div className="flex flex-col">
                        <label htmlFor="empresa" className="mb-2 text-gray-700 dark:text-gray-200">
                            Empresa
                        </label>
                        <input
                            id="empresa"
                    ...
                    {/* Socio */}
                    <div className="flex flex-col">
                        <label htmlFor="socio" className="mb-2 text-gray-700 dark:text-gray-200">
                            Socio
                        </label>
                        <input
                            id="socio"
                            ...
                            {...register("socio", { required: "Este campo es obligatorio" })}
                            className="px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-gray-100"
                        />
                        {errors.socio && <span className="text-red-500 text-sm">{errors.socio.message}</span>}
                    </div>
                    ...
                    <div className="flex flex-col md:col-span-2">
                        ...
                        <textarea
                            ...
                            className="px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-gray-100"
                        />
                        {errors.comentario && <span className="text-red-500 text-sm">{errors.comentario.message}</span>}
                    </div>
