                ...
                <div className="w-full max-w-4xl bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="flex flex-col">
                            ...
                            <input id="n_orden_servicio" type="text" placeholder="Ingrese numero orden servicio"
                        ...
                        <div className="flex flex-col">
                            ...
                            <input id="repuestos" type="text" placeholder="Ingrese el repuestos"
                        ...
                        <div className="flex flex-col">
                            ...
                            <input id="certificadora" type="text" placeholder="Ingrese certificadora"
                        ...
                        <div className="flex flex-col">
                            ...
                            <input id="tipo_unidad" type="text" placeholder="Ingrese tipo de unidad"
                        ...
                        <div className="flex flex-col">
                            ...
                            <input id="area" type="text" placeholder="Ingrese área" {...register("area", {
                                required: "Este campo es obligatorio" })}
                                className="px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-gray-100" />
                        ...
                        <div className="flex flex-col">
                            ...
                            <input id="inspector" type="text" placeholder="Ingrese inspector"
                        ...
                        <div className="flex flex-col">
                            ...
                            <input id="Departamento" type="text" placeholder="Ingrese departamento"
                        ...
                        <div className="flex flex-col">
                            ...
                            <input id="Provincia" type="text" placeholder="Ingrese provincia"
                        ...
                        <div className="flex flex-col">
                            ...
                            <input id="n_factura" type="text" placeholder="Ingrese número de factura"
                                {...register("n_factura")}
                                className="px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-gray-100" />
                        ...
                        <div className="flex flex-col">
                            ...
                            <input id="igv_pagar" type="number" step="0.01" placeholder="Ingrese IGV a Pagar"
                        ...
                        <div className="flex flex-col">
                            ...
                            <input id="detraccion" type="number" step="0.01" placeholder="Ingrese detracción"
                        ...
                        <div className="flex flex-col">
                            ...
                            <select id="verificado_factura" {...register("verificado_factura")}
                                className="px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-gray-100">
                        ...
                        <div className="flex flex-col">
                            ...
                            <select id="verificado_pago" {...register("verificado_pago")}
                                className="px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-gray-100">
                                <option value="">Seleccione</option>
                                <option value="si">Sí</option>
                                <option value="no">No</option>
                        ...
                        <div className="flex flex-col">
                            ...
                            <textarea id="descripcion_servicio" placeholder="Ingrese Descripcion del servicio"
